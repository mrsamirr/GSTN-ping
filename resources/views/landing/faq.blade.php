                ...
                @php
                    $faqs = [
                        [
                            ...
                            'answer' => 'BASE44 is an AI-powered application development platform that allows you to build custom software applications using natural language. Instead of writing code, you simply describe what you want your app to do, and our AI generates the application for you. It\'s designed to make app development accessible to everyone, regardless of technical background.',
                        ],
                        [
                            'question' => 'Do I need coding experience to use BASE44?',
                            'answer' => 'No, you don\'t need any coding experience to use BASE44. Our platform is designed specifically for non-technical users. You simply describe your app requirements in plain English, and our AI handles all the technical implementation. However, if you do have coding experience, you can also customize and extend your applications further.',
                        ],
                        [
                            'question' => 'What types of applications can I build with BASE44?',
                            'answer' => 'You can build a wide variety of applications including customer portals, internal business tools, productivity apps, data management systems, workflow automation tools, and MVP prototypes. BASE44 supports web applications, mobile-responsive interfaces, and can integrate with various third-party services and databases.',
                        ],
                        [
                            'question' => 'What kind of integrations does BASE44 support?',
                            'answer' => 'BASE44 supports integrations with popular services including Google Workspace, Microsoft 365, Slack, Zapier, Stripe for payments, various databases (MySQL, PostgreSQL, MongoDB), REST APIs, and many other third-party services. We\'re constantly adding new integrations based on user demand.',
                        ],
                        [
                            'question' => 'How are BASE44 applications deployed?',
                            'answer' => 'BASE44 applications are automatically deployed to secure cloud infrastructure with just one click. We handle all the server management, scaling, and maintenance for you. Your apps are hosted on enterprise-grade infrastructure with 99.9% uptime guarantee, SSL certificates, and automatic backups.',
                        ],
                        [
                        ...
                        [
                            'question' => 'Is my data secure with BASE44?',
